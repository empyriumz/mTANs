...
parser.add_argument("--alpha", type=int, default=100.0)
...
if __name__ == "__main__":
    ...
    params = (
        list(rec.parameters()) + list(dec.parameters()) + list(classifier.parameters())
    )
    print(
        "parameters:",
        utils.count_parameters(rec),
        utils.count_parameters(dec),
        utils.count_parameters(classifier),
    )
    ...
    for itr in range(1, args.niters + 1):
        ...
        print(
            "Iter: {}, recon_loss: {:.4f}, ce_loss: {:.4f}, acc: {:.4f}, mse: {:.4f}, val_loss: {:.4f}, val_acc: {:.4f}, test_acc: {:.4f}, test_auc: {:.4f}".format(
                itr,
                train_recon_loss / train_n,
                train_ce_loss / train_n,
                train_acc / train_n,
                mse / train_n,
                val_loss,
                val_acc,
